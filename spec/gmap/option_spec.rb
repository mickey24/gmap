    ...
    describe ".parse_option" do
      ...
      context "with -d" do
        it "should return {'dry_run' => true}" do
          Option.parse_option(%w|-d|).should include_hash({"dry_run" => true})
        end
      end
      ...
      context "with -g genome_index" do
        it "should return {'genome_index' => genome_index}" do
          Option.parse_option(%w|-g mouse|).should include_hash({"genome_index" => "mouse"})
        end
      end
      ...
      context "with -n chrnum" do
        it "should return {'chrnum' => chrnum}" do
          Option.parse_option(%w|-n 1-19,X,Y|).should include_hash({"chrnum" => "1-19,X,Y"})
        end
      end
      ...
      context "with -o output_dir" do
        it "should return {'output_dir' => output_dir}" do
          Option.parse_option(%w|-o /path/to/output_dir|).should include_hash({"output_dir" => "/path/to/output_dir"})
        end
      end
      ...
      context "with -p threads" do
        it "should return {'threads' => threads}" do
          Option.parse_option(%w|-p 2|).should include_hash({"threads" => 2})
        end
      end
      ...
      context "with -q queue" do
        it "should return {'queue' => queue}" do
          Option.parse_option(%w|-q node.q|).should include_hash({"queue" => "node.q"})
        end
      end
      ...
      context "with -t tool_name" do
        it "should return {'tool' => valid_tool_name}" do
          Option.parse_option(%w|-t tophat|).should include_hash({"tool" => "tophat"})
        end
      end
      ...
      context "with -h" do
        it "should return {'help' => help_message}" do
          Option.parse_option(%w|-h|).should have_key("help")
        end
      end
      ...
      context "with leading arguments" do
        it "should return {'input_files' => [input_file1, input_file2, ...]}" do
          Option.parse_option(%w|input_file1 input_file2|).should include_hash({"input_files" => %w|input_file1 input_file2|})
        end
      end
    end
  end
